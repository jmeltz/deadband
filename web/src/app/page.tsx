    ...
    <div className="space-y-6 max-w-6xl">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-xs text-db-muted mt-0.5">
                Three steps to go from empty inventory to a client-ready report.
              </p>
              <ol className="mt-4 space-y-2.5">
                <GettingStartedStep
                  n={1}
                  href="/scan"
                  label="Run a discovery scan"
                  sub="Probe a CIDR for PLCs, CNCs, and other industrial controllers"
                />
                <GettingStartedStep
                  n={2}
                  href="/assets"
                  label="Review and curate the asset list"
                  sub="Remove anything you don't want included; recheck against the advisory DB"
                />
                <GettingStartedStep
                  n={3}
                  href="/report"
                  label="Configure and export the HTML report"
                  sub="Pick scope and compliance frameworks, then download a self-contained file you can hand to a customer"
                />
              </ol>
            </div>
            <button
      ...
      {canExport && (
        <div className="flex items-center justify-end gap-3">
          <Link href="/report">
            <Button size="sm">Configure Report</Button>
          </Link>
        </div>
      )}
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <Card>
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/scan" className="text-xs text-db-teal-light hover:text-db-text transition-colors">
              Run scan
            </Link>
          </div>
          {lastJob ? (
